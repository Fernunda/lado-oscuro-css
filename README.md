...
5-Nombres de clases: Cada framework usa nombres distintos para lo mismo. Ejemplo: imagen responsiva es img-fluid en Bootstrap y responsive-img en Materialize.

6-Orden del menú: Bootstrap junta el logo y los links a la izquierda. Materialize pone el logo a la izquierda y los links se van solos a la derecha.
